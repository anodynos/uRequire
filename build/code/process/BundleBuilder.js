...
var BundleBuilder, YADC, l, uRequireConfigMasterDefaults, upath, _, _B, _Bs, _fs,
  __slice = [].slice,
  ...
  BundleBuilder.prototype._constructor = function() {
    ...
    */
    ...
    if (this.buildCfg.debugLevel != null) {
      _B.Logger.debugLevel = this.buildCfg.debugLevel;
    ...
    */
    ...
    if (be = (_ref2 = this.bundleCfg.dependencies) != null ? _ref2.bundleExports : void 0) {
      ...
      if (!_.isEmpty(this.bundleCfg.dependencies.bundleExports)) {
        if (l.deb(20)) {
          l.debug("@bundleCfg.dependencies.bundleExports' = \n", (_ref3 = this.bundleCfg.dependencies) != null ? _ref3.bundleExports : void 0);
        }
      }
    }
    ...
    if (this.isCheckAndFixPaths() && this.isCheckAndFixTemplate()) {
      ...
      return this.build = new this.Build(this.buildCfg);
    } else {
  ...
  BundleBuilder.prototype.isCheckAndFixPaths = function() {
    ...
    if (!this.bundleCfg.bundlePath) {
      if (cfgFile = (_ref = this.configs[0]) != null ? _ref.configFiles[0] : void 0) {
        if (l.deb(40)) {
          l.debug("Assuming bundlePath = '" + (upath.dirname(cfgFile)) + "' from 1st configFile: '" + cfgFile + "'");
        }
...
if (_B.Logger.debugLevel > 10 || true) {
