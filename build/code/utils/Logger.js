var VERSION = '0.3.0alpha18'; //injected by grunt:concat
...
Logger = (function() {
  ...
  Logger.prototype.VERSION = typeof VERSION === 'undefined' ? '{VERSION}' : VERSION;
  ...
  Logger.prototype.prettify = (function(util) {
    return function(o) {
