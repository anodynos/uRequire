...
describe("Dependency", function() {
  it("converts simple paths from bundleRelative to fileRelative", function() {
    var dep;
    dep = new Dependency('path/to/module', 'someRootModule.js', {
      dstFilenames: ['path/to/module.js']
    });
    expect(dep.name({
      relativeType: 'bundle'
  ...
  return it("uses modyleName & bundleFiles to convert from bundleRelative to fileRelative", function() {
    var dep;
    dep = new Dependency('path/from/bundleroot/to/some/nested/module', 'path/from/bundleroot/modyleName.js', {
...
describe("Dependency - resolving many", function() {
  return it("resolves bundle&file relative, finds external, global, notFound, webRootMap", function() {
    var bundle, bundleRelative, d, dep, dependencies, external, fileRelative, global, modyleName, notFoundInBundle, strDependencies, webRootMap, _i, _len;
    modyleName = 'actions/greet.js';
    bundle = {
      dstFilenames: ['main.js', 'actions/greet.js', 'calc/add.js', 'calc/multiply.js', 'calc/more/powerof.js', 'data/numbers.js', 'data/messages/bye.js', 'data/messages/hello.js']
    };
