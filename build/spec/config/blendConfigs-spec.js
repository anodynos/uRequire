...
var MasterDefaultsConfig, ResourceConverter, areEqual, areLike, areRLike, arrayizePushBlender, assert, blendConfigs, bundleBuildBlender, chai, dependenciesBindingsBlender, depracatedKeysBlender, expect, expectedResources, l, moveKeysBlender, resources, templateBlender, untrust, _, _B, _ref;
...
describe('blendConfigs & its Blenders: ', function() {
  ...
  describe("blending config with ResourceConverters :", function() {
    return it("converts array of RC-specs' into array of RC-instances", function() {
      ...
      return expect(areEqual(resultRCs.bundle.resources, expectedResources)).to.be["true"];
    });
  });
  ...
  return describe("`blendConfigs`:", function() {
    ...
    return describe("Nested & derived configs:", function() {
      ...
      it("correctly derives from many & nested user configs:", function() {
        return expect(areEqual(blended, {
          bundle: {
            path: "source/code",
            main: "index",
